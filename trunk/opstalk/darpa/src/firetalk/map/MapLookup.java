...
public class MapLookup {
	...
	public static String getMap(double lat, double lon, int sizeW, int sizeH,
			int zoom, Vector<MapMarker> markers, String mapType) {
		return _map.getURI(lat, lon, sizeW, sizeH, zoom,markers, mapType);
	}
	...
	public String getURI(double lat, double lon, int sizeW, int sizeH,
		...
		// map type
		sb.append("&").append("maptype").append("=").append("roadmap");
		// maps key
	...
	public String getURI(double lat, double lon, int sizeW, int sizeH,
		...
		for (int i = 0; i < markers.size(); i++)
			sb.append("&").append(MarkerUtils.toString(markers.get(i)));
		// map type
		sb.append("&").append("maptype").append("=").append(mapType);
		// maps key
		sb.append("&").append(GmapLicenseKey).append("=").append(GmapLicense);
	...
	public static void main(String[] args) {
		...
		String u3 = getMap(lat, lon, new MapMarker(lat, lon,
				MapMarker.MarkerColor.blue, 'a'));
		System.out.println(u3);

		String u4 = getMap(lat, lon, 250, 500, new MapMarker(lat, lon,
